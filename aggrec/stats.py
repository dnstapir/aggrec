...
from .models import StatsAggregatessResponse, StatsCreatorInformation, StatsCreatorsResponse
...
def get_stats_aggregates(request: Request) -> StatsAggregatessResponse:
